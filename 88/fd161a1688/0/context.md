...
✓ Starting...
⨯ Unable to acquire lock at /home/dhitech/projects/parcel-tracker/.next/...
...
2. **User asks where we left off**: I checked git history and found we were at Phase 14 (Final Delivery) with all major f...
...
Build a parcel tracking web app. ...
...
for me can you add some sample data with one or more user where there parcel still in on the way and also parcel delivery this months ? so i can test that state in dashboard
